...
thread=28
if 'phone_number' in data['conversations'][thread]['conversation']['conversation']['participant_data'][0].keys():
    #number
    phone=data['conversations'][thread]['conversation']['conversation']['participant_data'][0]['phone_number']['e164']
    #name
    name=data['conversations'][thread]['conversation']['conversation']['participant_data'][0]['fallback_name']
else:
    phone=data['conversations'][thread]['conversation']['conversation']['participant_data'][1]['phone_number']['e164']
    name=data['conversations'][thread]['conversation']['conversation']['participant_data'][1]['fallback_name']
  
for msg in data['conversations'][thread]['events']:
    count+=1
    #Inbound/Outbound
